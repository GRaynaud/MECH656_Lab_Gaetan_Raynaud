...
\begin{figure}
    \centering
    \input{Python/FittingAnemometer_toLatex.pgf}
...
\begin{figure}
    \centering
        \resizebox{0.8\linewidth}{!}{\input{Python/Mean_Velocity_profile.pgf}}
...
\begin{figure}
    \centering
        \resizebox{0.8\linewidth}{!}{\input{Python/U_RMS_Profile.pgf}}
...
\begin{figure}
    \centering
        \resizebox{0.8\linewidth}{!}{\input{Python/Skewness_Profile.pgf}}
